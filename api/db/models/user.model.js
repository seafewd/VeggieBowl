...
// jwt secret
const jwtSecret = '908263829246447792809082638292niuf23znzajidlzju5415094643';
...
UserSchema.methods.createSession = function() {
    ...
    return user.generateRefreshAuthToken().then((refreshToken) => {
        ...
        // saved successfully, return refresh token
        return refreshToken;
    }).catch((e) => {
...
UserSchema.pre('save', function(next) {
    ...
    if (user.isModified('password')) {
        // if password field has been edited/changed, run this code
